...
<div class="qr">
  <img src="./images/qr/qr-GAME-vid.png" alt="QR Code for Video">
  <p>Scan to watch: Adaptive Gaming Overview Video</p>
</div>

## Your Pathway to Play

Follow the belwo path to get a deep understanding of the equipment, video game literacy, and best practices around adaptive gaming:

1.  **Adaptive Gaming Equipment:** Explore [Alternative Access](alt-access.md), [Controller Modifications](control-mods.md), and [Software Features](video-game-accessibility.md).
